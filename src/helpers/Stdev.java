...
/**
 * @author http://www.java2s.com/example/java/java.math/returns-the-standard-deviation-of-the-bigdecimal.html
 */
public class Stdev {
    public static final BigDecimal TWO = BigDecimal.valueOf(2);

    public static BigDecimal stddev(List<BigDecimal> numbers,
    ...
    /**
     * Square root by coupled Newton iteration, sqrtProcedure() is the iteration
     * part I adopted the Algorithm from the
     * book "Pi-unleashed", so now it looks more natural I give sparse math comments
     * from the book, it assumes argument
     * mc precision >= 1
     *
     * @param mc
     * @param digits
